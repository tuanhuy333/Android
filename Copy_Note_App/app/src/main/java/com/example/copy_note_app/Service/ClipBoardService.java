package com.example.copy_note_app.Service;
...
public class ClipBoardService extends Service {
    ...
    //chỉ chạy lần đầu khi service đã được khởi tạo
    //nếu service đang chạy thì không chạy hàm onCreate()
    @Override
...
//
//
//        return START_NOT_STICKY; //se restart service khi he thong co dung luong
//    }
