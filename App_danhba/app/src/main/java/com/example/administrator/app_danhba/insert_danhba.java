...
public class insert_danhba extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        pick_image.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                // 1. Gọi Intent Pick ảnh trong device Android
                // 2. Lấy ảnh đã pick trong device ( @Override lại hàm onActivityResult(..) )
        ...
        img_call.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                //1.xin quyen goi dien thoai
                //2.Xử lý "kết quả xin quyền"
                //@Override lại onRequestPermissionResult(..)
    ...
    protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        //Lấy ảnh đã pick trong thiết bị
        //Nếu requestCode và resultCode phù hợp và data ảnh khác null thì lấy uri và chuyển thành bitmap
...
//                    camera_capture.setImageBitmap(photo);
//
//                }
//                super.onActivityResult(requestCode, resultCode, data);
//
