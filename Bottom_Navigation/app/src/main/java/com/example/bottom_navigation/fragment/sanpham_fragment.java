...
public class sanpham_fragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        recyclerView = (view).findViewById(R.id.recyclerView_sp);
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(getActivity(), add_sanpham.class));
            }
        });

        //chức năng search
        //tìm kiếm tương ứng với text thay đổi
    ...
    public void hienthi_database() {
        ...
        //set adapter
        adapter = new adapter_sanpham_row(getActivity(), R.layout.row_sp, list);
