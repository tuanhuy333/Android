...
public class donhang implements Serializable {
    ...
    public donhang(String tenkhachhang,int ma_sp, String ten_sp,int gia_nhapvao, int gia_ban, int soluong_sp, String donvi_tinh, byte[] hinh_sp) {
        this.tenkhachang=tenkhachhang;
        this.ma_sp = ma_sp;
        this.ten_sp = ten_sp;
